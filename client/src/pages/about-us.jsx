        ...
        <div>
                    ...
                    <div className="container">
                        <div className="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                            <div className="heading relative mb-0 text-center ltr:md:text-left rtl:md:text-right">
                                <h6>About Us</h6>
                                <h4 className="!text-white">About AUSTCMS</h4>
                            </div>
                            <div className="relative mt-6 md:mt-0" data-aos={isRtl ? 'fade-right' : 'fade-left'} data-aos-duration="1000">
                                <svg width="374" height="282" viewBox="0 0 374 282" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto w-[90%] rtl:rotate-y-180 sm:w-auto md:mx-auto">
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#47BDFF"
                                    />
                                    <path d="M261.058 91.8887L257.145 95.6065C257.507 94.5745 257.732 93.4997 257.814 92.4092C258.912 92.3565 260 92.182 261.058 91.8887Z" fill="#47BDFF" />
                                    <path
                                    ...
                                    <path d="M106.109 98.8112L101.647 95.8018C102.93 95.9559 104.223 96.0058 105.514 95.9505C105.616 96.9216 105.815 97.88 106.109 98.8112Z" fill="#47BDFF" />
                                    <path d="M243.81 111.602C242.863 113.932 242.333 116.411 242.245 118.926L239.754 117.401L243.81 111.602Z" fill="#47BDFF" />
                                    <path d="M125.143 111.861C125.475 113.482 125.711 115.12 125.85 116.769C126.556 116.434 127.337 116.025 128.118 115.616L125.143 111.861Z" fill="#47BDFF" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#47BDFF"
                                    />
                                    <path d="M92.73 124.721L90.018 128.216C89.6462 126.768 89.2744 125.353 88.8655 123.979C90.1237 124.203 92.73 124.721 92.73 124.721Z" fill="#47BDFF" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#47BDFF"
                                    />
                                    <path d="M337.79 98.6627C336.489 98.7371 334.184 98.8486 333.663 98.8858C334.63 95.802 336.344 95.7628 337.79 98.6627Z" fill="#47BDFF" />
                                    <path d="M338.98 116.509C338.05 119.037 336.526 119.148 335.225 116.806C336.303 116.74 337.604 116.62 338.98 116.509Z" fill="#47BDFF" />
                                    <path
                                    ...
                                    <path d="M194.849 237.443C180.326 239.257 165.58 237.692 151.761 232.87" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M269.313 181.115C260.353 202.099 244.077 219.115 223.511 228.999" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M275.26 127.511C276.084 131.954 276.568 136.453 276.71 140.969" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M197.637 51.6729C219.335 55.0833 239.141 66.0202 253.586 82.5678" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                    ...
                                    />
                                    <path d="M108.748 86.8763C122.591 69.0045 142.418 56.7281 164.587 52.3027" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                    />
                                    <path d="M132.391 223.426C121.629 216.524 112.383 207.508 105.216 196.92" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                    />
                                    <path d="M353.144 100.819C353.71 105.45 352.7 110.136 350.281 114.125" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                    />
                                    <path d="M261.654 176.584L259.051 165.542L264.628 174.019" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                    />
                                    <path d="M157.338 181.312C157.338 181.312 149.94 182.911 139.939 184.138" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                    />
                                    <path d="M121.909 151.825C120.05 151.862 118.228 151.937 116.406 152.011" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                    ...
                                    <path d="M47.5301 99.6289C45.712 106.416 46.05 113.601 48.4967 120.188" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M151.433 74.4619C157.021 78.1987 161.57 83.2917 164.655 89.2646" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                    />
                                    <path d="M208.976 249.301L221.8 200.155L259.497 167.401" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                    />
                                    <path d="M58.8202 180.528C51.5353 185.436 46.8841 193.392 44.0625 203.422" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
            ...
            <section className="relative pt-14 lg:pb-48 lg:pt-[100px]">
                <div className="container relative z-[1]">
                    <div className="text-center lg:w-1/2 ltr:lg:text-left rtl:lg:text-right">
                        <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right xl:w-[95%]">
                            <h6>Who we are</h6>
                            <h4>Empowering AUST clubs through innovative technology</h4>
                        </div>
                        <p className="pb-10 text-lg font-semibold leading-[30px]">
                            AUSTCMS is a pioneering project developed by a dedicated team of AUST students. Our mission is to revolutionize club management within our university, providing a
                            centralized platform that streamlines operations, enhances communication, and fosters greater engagement among club members and leaders.
                        </p>
                        <Link to="#" className="btn capitalize text-white">
                ...
                <div className="bottom-0 ltr:right-0 rtl:left-0 lg:absolute" data-aos={isRtl ? 'fade-right' : 'fade-left'} data-aos-duration="1000">
                    <img src="/assets/images/about-bg.png" alt="AUSTCMS Development Team" className="rtl:rotate-y-180" />
                </div>
            </section>
            ...
            <section className="relative py-14 lg:py-[100px] xl:-mt-[100px]">
                ...
                <div className="container relative z-[2] ltr:xl:pr-40 rtl:xl:pl-40">
                    <div className="lg:w-2/3">
                        <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                            <h6>How AUSTCMS Works</h6>
                            <h4>Streamlining Club Management in 3 Easy Steps</h4>
                        </div>
                        <p className="pb-10 text-center text-lg font-semibold leading-[30px] ltr:lg:text-left rtl:lg:text-right">
                            Discover how AUSTCMS simplifies club operations and enhances student engagement across AUST.
                        </p>
                    </div>
                ...
                hover:border-secondary hover:bg-transparent"
                            >
                                ...
                                <div>
                                    <h6 className="mb-1 font-bold text-secondary">Club Registration</h6>
                                    <p className="text-sm font-semibold text-black dark:text-gray">Easily register your club and manage member profiles through our intuitive interface.</p>
                                </div>
                            </div>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
                ...
                hover:border-secondary hover:bg-transparent"
                            >
                                ...
                                <div>
                                    <h6 className="mb-1 font-bold text-secondary">Event Planning</h6>
                                    <p className="text-sm font-semibold text-black dark:text-gray">Plan, schedule, and promote club events with our comprehensive event management tools.</p>
                                </div>
                            </div>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
                ...
                hover:border-secondary hover:bg-transparent"
                            >
                                ...
                                <div>
                                    <h6 className="mb-1 font-bold text-secondary">Engagement Analytics</h6>
                                    <p className="text-sm font-semibold text-black dark:text-gray">Track member participation and event success with our detailed analytics dashboard.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="group cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img src="/assets/images/alaminxpro.png" alt="team-member-1" className="h-full w-full rounded-3xl object-cover object-top" />
                            </div>
                            <h4 className="pt-5 pb-2 text-xl font-extrabold text-black transition duration-500 group-hover:text-secondary dark:text-white">MD. AL AMIN</h4>
                            <h6 className="text-sm font-bold">Founder of AUSTCMS</h6>
                        </div>
                        <div className="group cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img src="/assets/images/jaif-square.png" alt="team-member-2" className="h-full w-full rounded-3xl object-cover object-top" />
                            </div>
                            <h4 className="pt-5 pb-2 text-xl font-extrabold text-black transition duration-500 group-hover:text-secondary dark:text-white">Harique Jaif</h4>
                            <h6 className="text-sm font-bold">Chief Operating Officer</h6>
                        </div>
                        <div className="group cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img src="/assets/images/yeash-square.png" alt="team-member-3" className="h-full w-full rounded-3xl object-cover object-top" />
                            </div>
                            <h4 className="pt-5 pb-2 text-xl font-extrabold text-black transition duration-500 group-hover:text-secondary dark:text-white">Yeash Ahmed</h4>
                            <h6 className="text-sm font-bold">Chief Financial Officer</h6>
                        </div>
                        <div className="group cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img src="/assets/images/alaminxpro-400.png" alt="team-member-4" className="h-full w-full rounded-3xl object-cover object-top" />
                            </div>
                            <h4 className="pt-5 pb-2 text-xl font-extrabold text-black transition duration-500 group-hover:text-secondary dark:text-white">Prince Al Amin</h4>
                            <h6 className="text-sm font-bold">Software Engineer</h6>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="top-20 ltr:left-[105%] rtl:right-[105%] xl:absolute">
                                <svg width="320" height="282" viewBox="0 0 320 282" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto my-8 w-[90%] sm:w-auto">
                                    ...
                                    <path
                                        ...
                                        fill="#47BDFF"
                                    />
                                    <path d="M89.6872 93.1215L86.2843 84.6084C87.4194 86.1276 88.757 87.4848 90.2599 88.6426C89.9802 90.1228 89.789 91.6185 89.6872 93.1215Z" fill="#47BDFF" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                    />
                                    <path d="M111.632 160.368C97.0654 153.221 88.2873 134.257 87.9977 133.59" stroke="#7780A1" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                    ...
                                    <path d="M182.875 214.75C191.909 216.235 201.112 216.403 210.195 215.252" stroke="#7780A1" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M242.033 122.694C243.466 132.224 241.922 141.963 237.612 150.584" stroke="#7780A1" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
