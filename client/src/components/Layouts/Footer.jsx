            ...
            <div className="container">
                <div className="grid gap-y-10 gap-x-4 py-14 sm:grid-cols-3 lg:grid-cols-5 lg:py-[100px]">
                    <div className="relative">
                        <img src="/assets/images/logo-pink.png" alt="plurk" className="h-7" />
                        <ul className="mt-12 flex items-center gap-8">
                            <li>
                                <Link to="https://facebook.com/alaminxprof" target="_blank" rel="noreferrer">
                                    <svg
                                        width="10"
                                        height="20"
                                        viewBox="0 0 10 20"
                            ...
                            <li>
                                <Link to="https://www.twitter.com/alaminxpro/" target="_blank" rel="noreferrer">
                                    <svg
                                        width="23"
                                        height="18"
                                        viewBox="0 0 23 18"
                            ...
                            <li>
                                <Link to="https://www.instagram.com/alaminxpro/" target="_blank" rel="noreferrer">
                                    <svg
                                        width="23"
                                        height="22"
                                        viewBox="0 0 23 22"
                    ...
                    <div>
                        <ul className="flex flex-col gap-3 font-bold">
                            ...
                            <li>
                                <Link to="/login" className="inline-block transition hover:scale-110 hover:text-secondary">
                                    Login
                                </Link>
                            </li>
                            <li>
                                <Link to="/register" className="inline-block transition hover:scale-110 hover:text-secondary">
                                    Register
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        <ul className="flex flex-col gap-3 font-bold">
                            ...
                            <li>141 & 142, Love Road, Tejgaon Industrial Area, Dhaka-1208, Bangladesh</li>
                            <li>
                                <a className="inline-block transition hover:scale-110 hover:text-secondary">
                                (Registrar - 8870416)
                                </a>
                            </li>
                        </ul>
                ...
                <div className="container">
                    <div className="items-center justify-between text-center font-bold dark:text-white md:flex">
                        <div>
                            ...
                            <a href="https://www.linkedin.com/in/alaminxpro/" target="_blank" rel="noreferrer" className="text-primary transition hover:text-secondary">
                                AlaminXpro Technologies.
                            </a>
                        </div>
                        <div>
                            Need help? Visit the{' '}
